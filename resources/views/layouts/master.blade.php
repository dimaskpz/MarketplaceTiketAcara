...
<div class="w3-teal w3-bar w3-top w3-large" style="z-index:4">
  ...
  <a class="w3-bar-item w3-right" href="{{ route('logout') }}"
  ...
  <span class="w3-bar-item w3-right">VIHO Workshop System</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="{{ route('Dashboard_Default') }}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-dashboard fa-fw"></i>  Home</a>
